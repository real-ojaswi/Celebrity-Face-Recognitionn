...
if __name__== '__main__':    
    ...
    validation_file= 'data/validation_file.pth'  #file containing the list of indices for the images to be considered in 
                                                # validation set
    to_save_dir= 'RegnetCheckpoints2_data2' #  directory where checkpoints will be saved
    to_use_weight= 'RegnetCheckpoints2_data2/checkpoint_1.pth' # (OPTIONAL) the weight to be loaded
    ...
    ###################################################################################################################
    ######################################### MODEL AND TRAINING #####################################################
    regnet= models.regnet_y_32gf(models.RegNet_Y_32GF_Weights.IMAGENET1K_SWAG_E2E_V1)
    regnet.fc= nn.Linear(3712, 100)
