...
validation_file= 'data/validation_file.pth'  #file containing the list of indices for the images to be considered in 
                                             # validation set
to_save_dir= 'EfficientNetCheckpointsv2_data2' #  directory where checkpoints will be saved
...
my_trainer= Trainer(efficientnet, train_dataloader, val_dataloader, criterion, device)
